        ...
        function invokeHelper(frame, indent) {
            ...
            const thisHelperContext = {
                ...
                renderPrimary(newData) {
                    const childFrame = { value: newData, parent: frame };
                    return indent ? renderPrimary.renderIndented(childFrame, indent) : renderPrimary(childFrame);
                },

                renderInverse(newData) {
                    const childFrame = { value: newData, parent: frame };
                    return indent ? renderInverse.renderIndented(childFrame, indent) : renderInverse(childFrame);
                },
            };
